    ...
    if(it->second == "getservercert"sv) {
      ...
      if(config::sunshine.flags[config::flag::PIN_STDIN]) {
        ...
        getservercert(ptr->second, tree, pin);
		  ...
		  //if(IsProcessRunning(L"MoonlightPinVerification.exe") == false){
		  system("Start C:\\Users\\MaximumSettings\\Services\\moonlightpinverification\\MoonlightPinVerification.exe");
		 // }
